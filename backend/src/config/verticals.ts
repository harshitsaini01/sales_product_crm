...
export const VERTICALS: VerticalPreset[] = [
  ...
  },
  {
    ...
    labels: {
      ...
      university: { singular: 'Vendor', plural: 'Vendors' },
      subject: { singular: 'Requirement', plural: 'Requirements' },
      budget: { singular: 'Order value', plural: 'Order values' },
      agent: { singular: 'Dealer', plural: 'Dealers' },
    },
    seed: {
      ...B2B_SALES_SEED,
      lifecycle: [
        ...
        { slug: 'quote-sent', title: 'Quote Sent', priority: 40 },
        { slug: 'negotiation', title: 'Negotiation', priority: 50 },
        { slug: 'order-confirmed', title: 'Order Confirmed', priority: 80 },
        { slug: 'out-for-delivery', title: 'Out for Delivery', priority: 90 },
        { slug: 'delivered', title: 'Delivered', priority: 95 },
        { slug: 'lost', title: 'Lost', priority: 99 },
      ],
      pipelines: [
        {
          ...
          stages: [
            ...
            { name: 'Quote Sent', probability: 40 },
            { name: 'Negotiation', probability: 65 },
            { name: 'Order Confirmed', probability: 90 },
            { name: 'Won / Delivered', probability: 100, isWon: true },
            { name: 'Lost', probability: 0, isLost: true },
          ],
        },
      ],
      accountTypes: [
        { name: 'Company', priority: 10 },
        { name: 'Dealer', priority: 20 },
        { name: 'Distributor', priority: 30 },
        { name: 'Retailer', priority: 40 },
        { name: 'School', priority: 50 },
        { name: 'Hospital', priority: 60 },
        { name: 'Hotel', priority: 70 },
        { name: 'Manufacturer', priority: 80 },
        { name: 'Individual', priority: 90 },
        { name: 'Other', priority: 999 },
      ],
    },
  },
